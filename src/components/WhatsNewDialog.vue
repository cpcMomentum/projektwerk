<template>
	<NcModal
		...
		@close="dismiss">
		<!--
			NcModal teleportiert seinen Inhalt an den `body`, wo
			`.app-projektwerk` kein Vorfahr mehr ist. Ohne diese Klasse greift
			kein einziges der geschachtelten App-CSS (teleport-scoping.spec.ts).
		-->
...
/**
 * „Was ist neu?"-Fenster (#315). Zeigt einmal je Nutzer und Version die
 ...
 *
 * NcModal meldet X, Escape und den Klick daneben ueber dasselbe `close`-
 * Ereignis — ein eigener Escape-Handler ist darum nicht noetig (wie in
 * TicketDetail.vue).
 */
 ...
 *
 * @param name Symbolname aus der JSON, etwa `folder`.
 */
