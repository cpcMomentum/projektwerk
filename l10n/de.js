OC.L10N.register(
    "projektwerk",
    {
    "Was ist neu in ProjektWerk" : "Was ist neu in ProjektWerk",
    ...
    "Nach GitHub überführen" : "Nach GitHub überführen",
    ...
    "Neuen Token eingeben, um den vorhandenen zu ersetzen" : "Neuen Token eingeben, um den vorhandenen zu ersetzen",
    ...
    "Hier steht, was bei dir liegt und wie die Projekte stehen. Solange alle Vorgänge erledigt sind, bleibt die Seite leer." : "Hier steht, was bei dir liegt und wie die Projekte stehen. Solange alle Vorgänge erledigt sind, bleibt die Seite leer.",
    "Was bei mir liegt" : "Was bei mir liegt",
    ...
    "Noch keine Vorgänge" : "Noch keine Vorgänge",
    "Als Gast können Sie keine Projekte anlegen." : "Als Gast können Sie keine Projekte anlegen.",
    "Mitglieder dürfen eigene Boards in diesem Projekt anlegen" : "Mitglieder dürfen eigene Boards in diesem Projekt anlegen",
    "Damit können Arbeitsgruppen selbst ein Board anlegen und dessen Spalten pflegen. Alle Projektmitglieder sehen weiterhin alle Boards." : "Damit können Arbeitsgruppen selbst ein Board anlegen und dessen Spalten pflegen. Alle Projektmitglieder sehen weiterhin alle Boards.",
    ...
    "Antworten per E-Mail" : "Antworten per E-Mail",
    "Antworten auf Benachrichtigungs-E-Mails werden als Kommentar am Vorgang eingetragen. Dazu liest ProjektWerk ein IMAP-Postfach, das Sie hier hinterlegen. Es verlässt nichts die Instanz — das Postfach gehört Ihnen." : "Antworten auf Benachrichtigungs-E-Mails werden als Kommentar am Vorgang eingetragen. Dazu liest ProjektWerk ein IMAP-Postfach, das Sie hier hinterlegen. Es verlässt nichts die Instanz — das Postfach gehört Ihnen.",
    "Antworten per E-Mail aktivieren" : "Antworten per E-Mail aktivieren",
    "Ist der Schalter aus, ändert sich am Versand nichts — nur die Antwortadresse (Reply-To) wird dann nicht gesetzt." : "Ist der Schalter aus, ändert sich am Versand nichts — nur die Antwortadresse (Reply-To) wird dann nicht gesetzt.",
    "Antwortadresse" : "Antwortadresse",
    "Die Adresse, an die Kunden antworten (z. B. projekte@ihre-firma.de). Sie wird als Reply-To gesetzt und gehört zu dem Postfach unten." : "Die Adresse, an die Kunden antworten (z. B. projekte@ihre-firma.de). Sie wird als Reply-To gesetzt und gehört zu dem Postfach unten.",
    "Antwortadresse (Reply-To)" : "Antwortadresse (Reply-To)",
    "Posteingang (IMAP)" : "Posteingang (IMAP)",
    "Server" : "Server",
    "Port" : "Port",
    ...
    "Passwort" : "Passwort",
    "Gespeichert — zum Ändern neu eingeben" : "Gespeichert — zum Ändern neu eingeben",
    "Gespeichertes Passwort entfernen" : "Gespeichertes Passwort entfernen",
